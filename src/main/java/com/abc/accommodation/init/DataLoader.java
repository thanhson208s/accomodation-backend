...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        User user;
        user = new User("abc",passwordEncoder.encode("123"),"0962344567");
        user = userRepository.save(user);

        Post post;
        post= new Post("Cho thuê nhà","Thủ Đức, TP HCM",1000000.0,"0976282346","https://news.mogi.vn/wp-content/uploads/2019/09/nha-nguyen-can-cho-thue-3.jpg",user,"Nhà 4 phòng");
